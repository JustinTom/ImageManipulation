...
def rotate(imgObj):
	...
	#Finds the center of the image based on image size (height and width) and rearranges the pixels based on the rotation degree
	#using some triggonometric calculations with sin and cos math functions. 
